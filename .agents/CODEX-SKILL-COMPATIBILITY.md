...
| Status | Skills |
|---|---|
| Native | `applying-best-practices`, `brainstorming`, `caveman`, `conflict`, `design-truenote-ui`, `enhance-prompt`, `executing-plans`, `handoff-audit`, `humanizer`, `learning`, `purposeful-writing`, `recall`, `review-security-posture`, `systematic-debugging`, `test-driven-development`, `verification-before-completion`, `writing-plans` |
| Adapted | `addskill`, `finishing-a-development-branch`, `init-project`, `lab`, `optimize-context`, `sync-starter`, `using-git-worktrees`, `using-superpowers`, `writing-skills` |
