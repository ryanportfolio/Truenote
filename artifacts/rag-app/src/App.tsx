...
const loadAdminObservabilityPage = once(() =>
  import("@/pages/AdminObservability").then((module) => ({
...
const loadAdminSecurityPage = once(() =>
  import("@/pages/AdminSecurity").then((module) => ({
    ...
    >
      <Suspense fallback={<RouteBoot path={currentPath} />}>
        ...
        <Route path="/admin/security">
          <AdminSecurityPage user={auth.user} />
        </Route>
